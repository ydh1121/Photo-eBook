export const BLOCK_VARIANTS_V1=Object.freeze({
  hero:['image-metrics','immersive-metrics','minimal'],
  'chapter-hero':['image','image-overlay','compact'],
